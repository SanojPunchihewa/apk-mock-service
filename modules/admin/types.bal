...
public type CreatedCustomRule record {|
    *http:Created;
    CustomRule body;
|};
...
public type AlertsSubscription record {
    AlertType[] alerts?;
    string[] emailList?;
};
...
public type BotDetectionAlertSubscriptionList record {
    # Number of Bot Detection Alert Subscriptions returned.
    int count?;
    BotDetectionAlertSubscription[] list?;
};
...
public type CustomRuleList record {
...
public type AlertTypesList record {
...
public type BotDetectionAlertSubscription record {
